...
jQuery('.rich-text__blocks p').each(function() {
    ...
    if(words.length > maxWords){
    	...
    	jQuery(this).find('a.read_more').click(function(event){
            ...
            if(jQuery(this).hasClass("less")){
            	jQuery(this).html("<br/>[Read Less]")
                jQuery(this).parent().find(".more_text").show();
            }else{
            	jQuery(this).html("...<br/>[Read More]")
                jQuery(this).parent().find(".more_text").hide();
            }
        })
